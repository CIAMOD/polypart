...
from polypart.experiments import cli_batch, cli_single


def main() -> None:
    """Main entry point for experiment CLI."""
    ...
    sp_single.add_argument("-d", type=int, required=True, help="Dimension")
    sp_single.add_argument("-p", type=str, required=True, help="Polytope_class")
    sp_single.add_argument("-a", type=str, required=True, help="Arrangement_class")
    sp_single.add_argument("-m", type=int, required=True, help="Number of hyperplanes")
