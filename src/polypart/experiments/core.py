...
from polypart.experiments.runner import run_experiments, run_single_experiment
...
class PolytopeClass:
    """Factory for generating polytopes by class name."""

    def __init__(self, name: str, bbox_mode: bool = False) -> None:
        self.name = name
...
class ArrangementClass:
    """Factory for generating hyperplane arrangements by class name."""
